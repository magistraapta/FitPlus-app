...
class WorkoutViewModel: ObservableObject{
    ...
    func getData(){
        ...
        let wo3 = WorkoutModel(name: "Simple morning workout", description: "try workout with dicipline with 30 days workout program", image: "wo3", duration: 15)
        let wo4 = WorkoutModel(name: "30 Minutes workout", description: "try workout with dicipline with 30 days workout program", image: "wo4", duration: 15)
        let wo5 = WorkoutModel(name: "Sunday Chill Workout", description: "try workout with dicipline with 30 days workout program", image: "wo5", duration: 15)
        let wo6 = WorkoutModel(name: "TGIF Workout", description: "try workout with dicipline with 30 days workout program", image: "wo6", duration: 15)
